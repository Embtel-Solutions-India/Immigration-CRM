...
import { Bell, X, CheckCheck, AlertTriangle, Clock, TrendingDown, CalendarOff, Info } from 'lucide-react';
...
export default function NotificationPanel({ notifications, onClose, onMarkRead, onMarkAllRead }) {
  ...
  const handleClick = async (n) => {
    ...
    if (n.linkTo) { navigate(n.linkTo); onClose(); }
  };
  ...
  return (
    <div ref={ref} className="absolute right-0 top-12 w-96 bg-white rounded-xl shadow-2xl border border-gray-100 z-50 overflow-hidden">
      ...
      <div className="max-h-96 overflow-y-auto divide-y divide-gray-50">
        {notifications.length === 0 ? (
          ...
          notifications.map(n => (
            ...
            >
              <div className="mt-0.5 flex-shrink-0">{TYPE_ICON[n.type] || TYPE_ICON.general}</div>
